...
var domainList = document.querySelectorAll('.domain-lookup__prices')[0];
var domainChildren = domainList.children;
Object.values(domainChildren).forEach(function (child) {
  child.addEventListener('click', function () {
    if (child.firstElementChild.tagName === "SPAN") {
      Object.values(domainChildren).forEach(function (element) {
